...
import fithub from '../assets/image/fithub.jpg';
        ...
        <Navbar collapseOnSelect expand="lg" className="bg-body-tertiary px-3">
            <Navbar.Brand as={Link} to="/" className="fw-bold">
                <img
                    src={fithub}
                    alt="Fithub Logo"
                    style={{ width: "88px", height: "48px", borderRadius: "8px" }}
                />
            </Navbar.Brand>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                ...
                <Nav className="d-flex align-items-center">
                    ...
                    {/* ✅ New Button for Nearby Gyms */}
                    <Nav.Link as={Link} to="/gyms-near-me">
                        <Button variant="warning" className="mx-2" style={{ fontWeight: 'bold' }}>
                            Get Nearby Gyms
                        </Button>
                    </Nav.Link>
